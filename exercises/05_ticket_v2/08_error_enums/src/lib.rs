...
#[derive(Debug)]
enum TicketNewError {
    TitleError(String), //Title cannot be empty, Title cannot be longer than 50 bytes
    DescriptionError(String), //Description cannot be empty, Description cannot be longer than 500 bytes
}
